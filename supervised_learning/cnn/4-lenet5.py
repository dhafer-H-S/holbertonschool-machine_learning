...
def lenet5(x, y):
    ...
    convolution layer 2
    """
    pool2 = tf.keras.layers.MaxPooling2D(pool_size=(2, 2), strides=(2, 2), name='pool2')
    """
    max pooling layer 2
    """
    ...
    loss = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits_v2(labels=y, logits=fully_con3))
    """
